...
from gymkhana.constants.constants import WIN, MARGIN, WHITE
...
def player_and_triangle(player_1, player_2, win=WIN, margin=MARGIN):
        ...
        write_text("1", margin * 2.8, margin * 1.5, margin // 2.5, margin // 2.5, color=WHITE)
        write_text(
            "2", margin * 1.5,  margin * 2.8, margin // 2.5, margin // 2.5, color=WHITE, rotate=True
        )
        write_text(
            player_1.name,
            bas_i_2,
